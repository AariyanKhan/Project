...
public class Main extends JFrame implements ActionListener {
    ...
    public Main(){
     ...
     joinPanel.setBackground(new java.awt.Color(0, 102, 102));
     joinPanel.add(new JLabel("Host:"));
     
     joinIPAddress = new JTextField();
     joinIPAddress.setBackground(new java.awt.Color(0, 88, 88));
     joinIPAddress.setForeground(new java.awt.Color(255, 255, 255));
     joinIPAddress.setText("localhost");
     joinPanel.add(joinIPAddress);
     
     joinPanel.add(new JLabel("Port:"));
     joinPort = new JTextField();
     joinPort.setBackground(new java.awt.Color(0, 88, 88));
     joinPort.setForeground(new java.awt.Color(255, 255, 255));
     joinPort.setText("1234");//default port
     joinPanel.add(joinPort);
     
     joinPanel.add(new JLabel("User Name:"));
     joinUser = new JTextField();
     joinUser.setBackground(new java.awt.Color(0, 88, 88)); 
     joinUser.setForeground(new java.awt.Color(255, 255, 255));
     joinPanel.add(joinUser);
     
     this.add(joinPanel, BorderLayout.CENTER);

     hostPanel = new JPanel(new GridLayout(3,2, 5, 5));
     hostPanel.setBackground(new java.awt.Color(107, 106, 104));
     hostPanel.add(new JLabel("Port:"));
     hostPort = new JTextField();
     hostPort.setBackground(java.awt.SystemColor.activeCaptionBorder);
     hostPort.setText("1234");//default port
     hostPanel.add(hostPort);
     hostPanel.add(new JLabel("User Name:"));
     hostUser = new JTextField();
     hostUser.setBackground(java.awt.SystemColor.activeCaptionBorder);
	...
	//now start from tomorrow from here
